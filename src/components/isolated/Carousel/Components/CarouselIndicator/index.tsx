...
const CarouselIndicator = ({
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="absolute top-0 left-[-45%] z-0 aspect-video h-14 tablet:left-0 tablet:aspect-auto tablet:w-28 tablet:h-[52px] notebook:w-[180px] notebook:h-[88px] desktop:w-[13.3rem] desktop:h-[6.6rem]">
        <Image
